...
| **FastText** | Эмбеддинги из n-грамм |
...
**TF-IDF** был выбран как основа для решения благодаря:
...
└── notebooks.ipynb # Google Colab с исследованием
```
...
Простота и скорость TF-IDF сделали его оптимальным для решения


### Датасеты
https://vk.com/away.php?to=https%3A%2F%2Fwww.kaggle.com%2Fdatasets%2Fabhi8923shriv%2Fsentiment-analysis-dataset&utf=1
https://vk.com/away.php?to=https%3A%2F%2Fwww.kaggle.com%2Fdatasets%2Fyash612%2Fstockmarket-sentiment-dataset&utf=1
